...
bind pub m ".reloadbrain" pub_loadphrases
proc pub_addphrases {nick uhost hand chan arg} {
 reloadbrain [lindex $arg 0]
 puthelp "PRIVMSG $chan :Phrases added"
}
bind pub m ".addphrases" pub_loadphrases
proc pub_addphrases {nick uhost hand chan arg} {
 learnfile [lindex $arg 0]
 puthelp "PRIVMSG $chan :Phrases added"
}
bind pub m ".loadphrases" pub_loadphrases
proc pub_loadphrases {nick uhost hand chan arg} {
 reloadphrases
 puthelp "PRIVMSG $chan :Phrases loaded"
}
